...
Verified on macOS 26.2 / Apple Silicon with Electron 44.2.0 and Next.js 16.1.6. The release runtime is `1.9.0-9e825626-c99f-42ba-bd01-112106bf5da0`.
...
| Full Vitest suite | 155 files, 2,961 tests passed |
| Main-process persistence/lifecycle tests | 9 tests passed |
...
```text
de6bdb0b6519b4a9ed0d3f86b91a429f5680e6e8cdce5d7aa2c871edde04ab27  Node Banana-1.9.0-arm64.dmg
7cfd8bfbd605e3a2a25363f4a8407c18216b2062525c4979ed0e89fc69e6cefd  Node Banana-1.9.0-arm64.zip
```
